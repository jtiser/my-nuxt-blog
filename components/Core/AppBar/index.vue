<template>
  <v-app-bar fixed dark color="primary darken-2" shrink-on-scroll :src="backgroundImg">
    ...
    <prismic-link
      ...
      :field="link"
    >
      <link-btn class="ml-2 d-none d-md-flex">{{label}}</link-btn>
    </prismic-link>

    <link-btn class="ml-2 d-none d-md-flex" link="/">Home</link-btn>
    <link-btn class="ml-2 d-none d-md-flex" link="/about">About</link-btn>
  </v-app-bar>
</template>
